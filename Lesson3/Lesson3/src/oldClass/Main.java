...
public class Main {
    public static void main(String[] args) {
        ...
        groupService.addStudent(ivan);
        groupService.addStudent(igor);
        groupService.addStudent(masha);
        groupService.addStudent(ira);
        groupService.addStudent(tochka);
        groupService.addStudent(tana);
        groupService.addStudent(vova);
...
//        System.out.println(studentGroup);
        ...
        Collections.sort(students, (s1, s2) -> s1.getId() - s2.getId()); // Сортировка по id
